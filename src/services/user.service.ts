...
export async function getUserById(
  ...
  return wrapDatabaseError('getUserById', async () => {
    let query = db
      .selectFrom('user')
      .where('id', '=', input.id);
...
export async function getUserByExternalAuthId(
  ...
  return wrapDatabaseError('getUserByExternalAuthId', async () => {
    return db
      .selectFrom('user')
...
export async function getUserByEmail(
  ...
  return wrapDatabaseError('getUserByEmail', async () => {
    let query = db
      .selectFrom('user')
...
export async function getUsersByTenant(
  ...
  return wrapDatabaseError('getUsersByTenant', async () => {
    let query = db
      .selectFrom('user')
...
export async function deleteUser(
  ...
  return wrapDatabaseError('deleteUser', async () => {
    let query = db
      .deleteFrom('user')
      .where('id', '=', input.id);
